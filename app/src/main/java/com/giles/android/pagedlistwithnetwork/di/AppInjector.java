...
public class AppInjector {
    ...
    public static void init(PagelistWithNetworkApp pagelistWithNetworkApp) {

        DaggerAppComponent.builder()
                .application(pagelistWithNetworkApp)
                .build()
                .inject(pagelistWithNetworkApp);

        pagelistWithNetworkApp.registerActivityLifecycleCallbacks(new Application.ActivityLifecycleCallbacks() {
            @Override
            public void onActivityCreated(Activity activity,
                                          Bundle savedInstanceState) {
                Timber.d("onActivityCreated activity = " + activity);
